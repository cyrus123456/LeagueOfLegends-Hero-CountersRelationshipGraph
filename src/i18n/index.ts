...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    title: '英雄联盟英雄被克制关系图',
    subtitle: 'League of Legends Hero Counters - 谁克制我',
    allHeroes: '全部英雄',
    heroes: '英雄',
    tank: '坦克',
    fighter: '战士',
  ...
  en: {
    title: 'League of Legends Hero Counter Relationships',
  ...
  ja: {
    ...
    subtitle: 'League of Legends ヒーローカウンター チェッカー',
    allHeroes: '全ヒーロー',
    heroes: 'ヒーロー',
    tank: 'タンク',
    fighter: 'ファイター',
  ...
  ko: {
    title: '오버워치 2 영웅 상성도',
    subtitle: 'League of Legends 영웅 카운터 관계',
    allHeroes: '전체 영웅',
    heroes: '영웅',
    tank: '탱커',
    fighter: '파이터',
  ...
  'zh-TW': {
    title: '鬥陣特攻英雄被剋制關係圖',
    subtitle: 'League of Legends Hero Counters - 誰剋制我',
    allHeroes: '全部英雄',
    heroes: '英雄',
    tank: '坦克',
    fighter: '戰士',
  ...
  es: {
    title: 'Sobrecarga de Contadores de Héroes de League of Legends',
  ...
  fr: {
    title: 'Relations de Contre des Héros League of Legends',
  ...
  de: {
    title: 'League of Legends Helden Gegenbeziehungen',
  ...
  pt: {
    title: 'Relações de Contra de Heróis League of Legends',
    ...
    midlane: 'Mid',
    adc: 'Atirador',
    adcLane: 'Rota Inferior',
    supportLane: 'Errante',
    roleFilter: 'Filtro de Rota',
    allLanes: 'Todas as Rotas',
  ...
  ru: {
    title: 'Отношения Контроу Героев League of Legends',
  ...
  it: {
    title: 'Relazioni di Contro degli Eroi League of Legends',
    ...
    midlane: 'Mid',
    adc: 'Tiratore',
    adcLane: 'Viale Inferiore',
    supportLane: 'Errante',
    roleFilter: 'Filtro Corsia',
    allLanes: 'Tutte le Corsie',
